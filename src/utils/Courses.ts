...
const GuidedCourse: Course = {
  ...
  levels: [
    ...
    { description: "Home row; right hand; index", keyBoardRows: [2], hand: Hand.LEFT, fingers: [Finger.INDEX] },
    {
    ...
    { description: "Home row; right hand; any", keyBoardRows: [2], hand: Hand.LEFT, fingers: [Finger.ANY] },
    ...
    { description: "Top row; right hand; index", keyBoardRows: [1], hand: Hand.LEFT, fingers: [Finger.INDEX] },
    {
    ...
    { description: "Top row; right hand; any", keyBoardRows: [1], hand: Hand.LEFT, fingers: [Finger.ANY] },
    ...
    { description: "Bottom row; right hand; index", keyBoardRows: [3], hand: Hand.LEFT, fingers: [Finger.INDEX] },
    {
    ...
    { description: "Bottom row; right hand; any", keyBoardRows: [3], hand: Hand.LEFT, fingers: [Finger.ANY] },
...
const Courses: { [key: string]: Course } = { guidedCourse: GuidedCourse, fingers: Fingers }
