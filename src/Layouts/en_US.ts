import { CharacterBehavior, CharacterSet, CharacterType, KeyboardKeyLabels } from "./layouts"
...
export const en_US_CharSet:  CharacterSet = [
   ...
   { code: ['Digit9', 'Digit0'],glyph: ['(', ')'], type: CharacterType.PUNCTUATION, behavior: CharacterBehavior.BRACKET },
